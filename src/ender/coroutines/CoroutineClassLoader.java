 ...
 * @author yanfengbing
 * @version 1.0
 * @since 1/5/16 2:44 PM
 */
final class CoroutineClassLoader extends URLClassLoader
{
	private final CoroutineClassTransformer transformer;
	...
	{
		super(new URL[0], fixNullParent(parent));
		this.transformer = new CoroutineClassTransformer(parent);
